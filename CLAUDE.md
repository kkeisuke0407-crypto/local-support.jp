...
## 連絡先共有（2026-09-09 決定）
- 🚫 **依頼者の承諾を取る前に、連絡先を業者へ渡さない。**
  「お伝えいたしました」と完了形で書くのは事後承諾であり禁止。
  「ご紹介してよろしいでしょうか」と必ず問いにする
- 別件（日程の可否など）への回答を承諾とみなさない
- 紹介可が1社だけのときは A:この1社で進める／B:他社を待つ／C:打診先を増やす を
  依頼者に選ばせる。運営が待つか進むかを決めない
